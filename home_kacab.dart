...
class Home_kacab extends StatefulWidget {
  ...
  Home_kacab(this.varpbuser, this.varniksales, this.varkdsales, this.varnmuser,
      this.bagian);

  @override
  State<Home_kacab> createState() => _Home_kacabState();
}

class _Home_kacabState extends State<Home_kacab> {
